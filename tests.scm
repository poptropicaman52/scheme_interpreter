...
(begin (define x 45)(define y (+ 1 x)))
;expect y
...
(define (exponent base power) (expt base power))
;expect exponent

exponent
;expect (lambda (base power) (expt base power))
...
(define (expression x y z) (cond (x x)(y y)(else z)))
;expect expression
